...
export default function SettingsModal({ admins, onAddAdmin, onToggleHidden, onDeleteAdmin, onClose }) {
  ...
  return (
    <BottomSheet onClose={onClose}>
      ...
      <div className="space-y-2 mb-4">
        {admins.map((adm) => (
          <div key={adm.key} className="flex items-center gap-2 border border-fc-line rounded-xl p-2.5">
